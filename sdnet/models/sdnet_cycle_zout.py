...
class MEncoder(nn.Module):
    def __init__(self, z_length):
        ...
        self.block1 = conv_bn_lrelu(1, 16, 3, 2, 1)  #############
...
class SDNet_cycle_zout(nn.Module):
    ...
    def forward(self, x, mask, script_type):
        ...
        if script_type == 'training':
            ...
            z_out_tilde = z_out #dummy assignment, not needed during validation

        return reco, z_out, z_out_tilde, a_out, seg_pred, mu_out, logvar_out, mu_out, logvar_out